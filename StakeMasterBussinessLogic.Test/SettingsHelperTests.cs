...
namespace StakeMasterBussinessLogic.Test
{
	...
	public sealed class SettingsHelperTests
	{
		...
		[DataRow(new[] { "--stakeaddress=adr1", "--collectaddress=adr2", "--user=user", "--password=pass", "--uri=localhost:1234" }, "adr1", "adr2", "user", "pass", "localhost:1234")]
		...
		[DataTestMethod]
		[DataRow(new[] { "-a=adr1", "-c=adr2", "-u=user", "-p=pass", "-o=localhost:1234", "-s=true", "-w=11", "-i=true", "-e=xadr1,xadr2" }, "adr1", "adr2", "user", "pass", "localhost:1234", true, 11, true, new[]{"xadr1", "xadr2", "adr1", "adr2"})]
		[DataRow(new[] { "-a=adr1", "-c=adr2", "-u=user", "-p=pass", "-o=localhost:1234", "-s=true", "-w=13", "-i=true", "-e=" }, "adr1", "adr2", "user", "pass", "localhost:1234", true, 13, true, new[] { "adr1", "adr2" })]
		[DataRow(new[] { "-a=adr1", "-c=adr2", "-u=user", "-p=pass", "-o=localhost:1234", "-s=false", "-w=12", "-i=false", "-e=xadr3,xadr4" }, "adr1", "adr2", "user", "pass", "localhost:1234", false, 12, false, new[] { "xadr3", "xadr4", "adr1", "adr2" })]
		[DataRow(new[] { "--stakeaddress=adr1", "--collectaddress=adr2", "--user=user", "--password=pass", "--uri=localhost:1234", "--stakes=true", "--patience=11", "--collectinputs=true", "--excludeaddress=xadr1,xadr2" }, "adr1", "adr2", "user", "pass", "localhost:1234", true, 11, true, new[] { "xadr1", "xadr2", "adr1", "adr2" })]
		[DataRow(new[] { "--stakeaddress=adr1", "--collectaddress=adr2", "--user=user", "--password=pass", "--uri=localhost:1234", "--stakes=false", "--patience=13", "--collectinputs=false", "--excludeaddress=xadr5,xadr6" }, "adr1", "adr2", "user", "pass", "localhost:1234", false, 13, false, new[] { "xadr5", "xadr6", "adr1", "adr2" })]
		public void Read_AllArgumentsPresent(string[] args, string stakeAddress, string collectAddress, string user, string password, string uri, bool stake, int patience, bool collect, [NotNull] string[] exclude)
		{
			//Arrange
			var expectedUri = new Uri(uri, UriKind.Absolute);
			//Act
